...
class UsuarioTelefone:
    def __init__(self, nome, numero, plano):
        self._nome = nome
        self._numero = numero
        self._plano = Plano(saldo_inicial,duracao)
...
class Plano:
    def __init__(self, saldo_inicial, duracao):
...
class UsuarioPrePago(UsuarioTelefone):
    def __init__(self, nome, numero, saldo_inicial, duracao):
        super().__init__(nome, numero, Plano(saldo_inicial, duracao))
...
usuario_pre_pago = UsuarioPrePago(nome, numero, saldo_inicial, duracao)
